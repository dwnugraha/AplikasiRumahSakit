...
Public Class dokter
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        sql = "INSERT INTO dokter(kd_dokter, nm_dokter, spesialis, no_telp, tarif) VALUES('" & kd_dokter.Text & "','" & nama.Text & "','" & spesialis.Text & "','" & no_telp.Text & "','" & tarif.Text & "')"
        Try
        ...
        Try
            ...
            dbread = dbcomm.ExecuteReader()
            While dbread.Read
                DataGridView1.Rows.Add(dbread("kd_dokter"), dbread("nm_dokter"), dbread("spesialis"), dbread("no_telp"), dbread("tarif").ToString)
            End While
            dbread.Close()
        Catch ex As Exception
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        sql = "update dokter set nm_dokter='" & nama.Text & "', spesialis='" & spesialis.Text & "', no_telp='" & no_telp.Text & "', tarif='" & tarif.Text & "' where kd_dokter='" & kd_dokter.Text & "'"
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        sql = "delete FROM dokter where kd_dokter='" & kd_dokter.Text & "'"
        Try
            dbcomm = New MySqlCommand(sql, dbconn)
            dbread = dbcomm.ExecuteReader()
            dbread.Close()
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        End If
        Using stream As New FileStream(folderPath & "Dokter.pdf",
        FileMode.Create)
